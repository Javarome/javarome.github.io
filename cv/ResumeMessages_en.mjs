...
class ResumeMessages_en extends ResumeMessages {
  people = {
    ...
    statement: "+30 years of front and back development experience, leading and motivating developers teams. I design my projects to stay maintainables and allow integrating changes quickly. Spécialised in standard and vanilla web. I can handle a project from requirements definition to production."
  }
  skills = {
    title: "Skills",
