...
class SkillList_fr extends SkillList {
  js = new Skill("JavaScript", new URL("https://ecma-international.org/publications-and-standards/standards/ecma-262/"), "Langage de programmation pour les navigateurs et NodeJS", [], ["language"])
  ...
  macos = new Skill("XCode", new URL("https://fr.wikipedia.org/wiki/MacOS"), `MacOS est le système d'exploitation des ordinateurs Apple Mac`, [], ["os"])
  ...
  mysql = new Skill("MySQL", new URL("https://www.mysql.com"), `MySQL est un <abbr title="Système de Gestion de Base de données">SGBDR</abbr>`, [this.java], ["database"])
