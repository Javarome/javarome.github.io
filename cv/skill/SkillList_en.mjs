...
class SkillList_en extends SkillList {
  ...
  ts = new Skill("TypeScript", new URL("https://www.typescriptlang.org"), `Microsoft's superset of JavaScript to add typing and OOP`, this.js)
  angularJS = new Skill("AngularJS", new URL("https://angularjs.org"), `Legacy Google web framework. Old version of Angular.`, this.ts)
  angular = new Skill("Angular", new URL("https://angular.io"), "Google web framework. Modern version of AngularJS.", this.ts)
  nx = new Skill("Nx", new URL("https://nx.dev"), "Monorepo tooling", this.js, this.ts)
  ...
  fastify = new Skill("Fastify", new URL("https://fastify.dev"), `Fastify is a TypeScript web server framework`, this.js)
  nodejs = new Skill("NodeJS", new URL("https://nodejs.org"), `NodeJS allows to buid JavaScript apps outside of a browser`, this.js)
  python = new Skill("Python", new URL("https://www.python.org"), `Python is a programming language used by most ML libraries`, this.js)
  graphql = new Skill("GraphQL", new URL("https://graphql.org/"), `GraphQL is a standard to query server APIs in a tailored fashion`, this.js)
