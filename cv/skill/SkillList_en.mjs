...
class SkillList_en extends SkillList {
  ...
  vanillaJS = new Skill("Vanilla", new URL("http://vanilla-js.com"), `JavaScript or TypeScript used without any other fancy frameworks`, [], ["vanilla"])
  vanillaTS = new Skill("Vanilla TS", undefined, `TypeScript used without any other fancy frameworks`, [this.ts], ["vanilla"])
  webComponents = new Skill("Web components", new URL("https://developer.mozilla.org/en-US/docs/Web/API/Web_components"), `A suite of different technologies allowing you to create reusable custom elements`, [this.html], ["web", "vanilla"])
  ...
  mysql = new Skill("MySQL", new URL("https://www.mysql.com"), `MySQL is a <abbr title="Relational Data Base Management System">RDBMS</abbr>`, [], ["database"])
  ...
  ethers = new Skill("Ethers", new URL("https://ethers.org/"), `Ethers is a JavaScript library to access Ethereum blockchain`, [this.js], ["blockchain"])
