...
class SkillList_en extends SkillList {
  angularJS = new Skill("AngularJS", new URL("https://angularjs.org"), `Legacy Google web framework. Old version of Angular.`, "web-framework", "angular", "javascript", "typescript")
...
export const skillList_fr = new SkillList_en()
