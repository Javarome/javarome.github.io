...
class SkillList_fr extends SkillList {
  ...
  angular = new Skill("Angular", new URL("https://angular.io"), `Le framework web de Google. Version moderne de AngularJS.`, "javascript", "typescript")
  ...
  ts = new Skill("TypeScript", new URL("https://www.typescriptlang.org/fr/"), "Microsoft's superset of JavaScript to add typing and OOP", "javascript", "typescript")
